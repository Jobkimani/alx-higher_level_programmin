SQL - Introduction
This marked my initiation into working with SQL and relational databases. My initial foray involved practicing fundamental data definition and data manipulation language tasks, delving into subqueries, and incorporating functions.
...
15-groups.sql: MySQL script that lists the score and the number of records with the same score in the table second_table in order of descending count.
16. Say my name
...
103-max_state.sql: MySQL script that displays the max temperature of each state in order of the state name.
