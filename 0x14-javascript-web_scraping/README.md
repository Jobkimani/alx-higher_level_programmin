...
This project entailed honing skills in file I/O using Node.js and utilizing the NPM request framework to interact with both the Star Wars and JSONplaceholder APIs.
...
2-statuscode.js: JavaScript script that displays the status code of a GET request using the request framework.
